import{j as e,b as D}from"./Router.CqMvBI1v.js";import{a as i}from"./index.CfTCg2BY.js";import{T as h}from"./teacherApprovalService.BjpnRRYx.js";import{m as s}from"./proxy.BsMkVvIS.js";import{C as x}from"./circle-check-big.XCMYNkZz.js";import{C as E}from"./circle-alert.Cu02mmpt.js";import{M as F}from"./mail.Dy2FRZL1.js";import{P as L}from"./phone.sfudtzXo.js";import{F as N}from"./file-text.CdpwbeDz.js";import{L as w}from"./loader.P-dpIgR3.js";import{C as A}from"./circle-x.BTFQCrfS.js";import{C as O}from"./clock.CEJISmQw.js";function q(){const[R,T]=i.useState([]),[S,u]=i.useState(!0),[t,l]=i.useState(null),[c,d]=i.useState(!1),[f,m]=i.useState(""),[b,n]=i.useState(""),[p,P]=i.useState("pending"),o=a=>a.status??a.approvalStatus??"pending";i.useEffect(()=>{g()},[]);const g=async()=>{u(!0);try{const a=await h.getPendingApprovals();T(a),console.log("[TeacherApprovalPage] Loaded approvals:",a.length)}catch(a){console.error("[TeacherApprovalPage] Error loading approvals:",a),n("Failed to load approval records")}finally{u(!1)}},k=async a=>{if(a.email){d(!0),n(""),m("");try{console.log("[TeacherApprovalPage] Approving teacher:",a.email),await h.approveTeacher(a.email,"admin");const r=`
        <!DOCTYPE html>
        <html>
          <head>
            <style>
